...
import ekoramadhan.shape.Library.Icon.albumIcon;
...
import ekoramadhan.shape.Library.Icon.musiclibreryIcon;
import ekoramadhan.shape.Library.Icon.normalBack;
import ekoramadhan.shape.Library.Icon.selectBack;
import ekoramadhan.shape.Library.Icon.songsIcon;
import ekoramadhan.shape.Library.allsong.itemRect;
...
public class btmView extends FMlyt{
    ...
    public btmView(Context context, int width, int height) {
        ...
        for(int i = 0;i < icons.length;i++){
            ...
            if(i == 0){
                img = new musiclibreryIcon(iconSize,iconSize,0,0);
            }else if(i == 1){
                img = new songsIcon(iconSize,iconSize,0,0);
            }else if(i == 2){
                img = new albumIcon(iconSize,iconSize,0,0);
            }else if(i == 3){
                img = new artistIcon(iconSize,iconSize,0,0);
            }else if(i == 4){
                img = new genreIcon(iconSize,iconSize,0,0);
            }else{
                img = new folderIcon(iconSize,iconSize,0,0);
            }
