...
import ekoramadhan.shape.Library.Icon.songsIcon;
...
public class Songs extends pagePrototype {
    ...
    public Songs(Context context, int width, int height,int id) {
        ...
        listview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                songAdapter.Item itemOne = (songAdapter.Item) view.getChildAt(0);
                songAdapter.Item itemTwo = (songAdapter.Item) view.getChildAt(1);
                if(itemOne != null){
        ...
        title = textImg.getFMText(context,"ALL SONGS", Ui.cd.getHt(18));
