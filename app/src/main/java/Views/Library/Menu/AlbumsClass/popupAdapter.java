...
public class popupAdapter extends BaseAdapter {
    ...
    public  String getId(){
        return "AND " + MediaStore.Audio.Media.ALBUM_ID +" = ";
    }
                    ...
                    final songsBtns mn = new songsBtns(context, Ui.cd.DPW, Ui.cd.DPH){
                        ...
                        public void onBtn(String name) {
                            ...
                            if(name.equals("PLAY ALL")){
                                Ui.ef.MusicPlayer.handler.playALlSong(0,getAIDs(),"ALBUM : " + getName());
                                Ui.bk.back();
                ...
                public void onClick(View v) {
                   ...
                   //Ui.ef.MusicPlayer.handler.playByPlaylistName("ok");
                    if(seclection){
                        ...
                        Ui.ef.MusicPlayer.handler.playALlSong(position,getAIDs(),"ALBUM : " + getName());
                    }
