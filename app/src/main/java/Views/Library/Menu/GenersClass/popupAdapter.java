...
import ekoramadhan.shape.home.menu.songDots;
...
public class popupAdapter extends BaseAdapter {
    ...
    public popupAdapter(){
            ...
            String[] cols = new String[] {MediaStore.Audio.Genres.Members.TITLE, MediaStore.Audio.Genres.Members.AUDIO_ID, MediaStore.Audio.Genres.Members.DATA};
            Cursor cursor = Ui.ef.getBaseContext().getContentResolver().query(MediaStore.Audio.Genres.Members.getContentUri("external", Long.parseLong(getId())),cols, searchString,searchPram, MediaStore.Audio.Media.TITLE +" COLLATE NOCASE ASC");
                    ...
                    final songsBtns mn = new songsBtns(context, Ui.cd.DPW, Ui.cd.DPH){
                        ...
                        public void onBtn(String name) {
                            ...
                            if(name.equals("PLAY ALL")){
                                Ui.ef.MusicPlayer.handler.playALlSong(position,getAIDs(),"GENRES : " + getName());
                                Ui.bk.back();
