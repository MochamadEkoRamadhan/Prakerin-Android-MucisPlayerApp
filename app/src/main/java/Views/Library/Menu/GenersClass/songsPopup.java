...
import ekoramadhan.shape.home.menu.itemMenu;
import ekoramadhan.shape.home.menu.playBtn;
import ekoramadhan.shape.home.menu.playTItleback;
    ...
    public songsPopup(Context context, int width, int height, String[] data) {
       ...
       // Menu.addView(forText);
        ...
        pb.onClick(new call(){
            @Override
            public void onCall(boolean bl) {
                Ui.ef.MusicPlayer.handler.playALlSong(0, getGenersAIDs(),"GENRE : " + songsPopup.this.data[0]);
                Ui.bk.back();
            }
        });

        textImg play = textImg.getText("PLAY GENRE", Ui.cd.getHt(16));
        ...
        aMenu.onClick(new call(){
            ...
            public void onCall(boolean bl) {
                ...
                final genersBtns mn = new genersBtns(getContext(), Ui.cd.DPW, Ui.cd.DPH,songsPopup.this.data);
                mn.fromHtml = true;
