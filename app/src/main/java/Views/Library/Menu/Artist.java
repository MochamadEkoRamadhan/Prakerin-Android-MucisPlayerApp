...
import ekoramadhan.shape.Library.Icon.artistIcon;
...
import Views.Library.Menu.ArtistClass.artistAdapter;
...
public class Artist extends pagePrototype {
    ...
    public Artist(Context context, int width, int height,int id) {
        ...
        listview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                artistAdapter.Item itemOne = (artistAdapter.Item) view.getChildAt(0);
                artistAdapter.Item itemTwo = (artistAdapter.Item) view.getChildAt(1);
                if(itemOne != null){
        ...
        title = textImg.getFMText(context,"ARTISTS", Ui.cd.getHt(18));
