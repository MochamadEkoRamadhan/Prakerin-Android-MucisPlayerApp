...
public class popupAdapter extends BaseAdapter {
    ...
    public popupAdapter(){
            ...
            Cursor cursor = Ui.ef.getContentResolver().query(
                MediaStore.Audio.Playlists.Members.getContentUri("external", Integer.parseInt(getId())), projection,
                    ...
                    final songsBtns mn = new songsBtns(context, Ui.cd.DPW, Ui.cd.DPH){
                        ...
                        public void onBtn(String name) {
                            ...
                            if(name.equals("PLAY ALL")){
                                Ui.ef.MusicPlayer.handler.playALlSong(0,getAIDs(),getName());
                                Ui.bk.back();
                ...
                public void onClick(View v) {
                   ...
                   //Ui.ef.MusicPlayer.handler.playByPlaylistName("ok");
                    if(seclection){
                        ...
                        Ui.ef.MusicPlayer.handler.playByPlaylistId(popupAdapter.this.getId(),position);
                    }
