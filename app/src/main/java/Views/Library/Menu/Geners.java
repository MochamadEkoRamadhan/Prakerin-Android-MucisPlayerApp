...
import ekoramadhan.linedeer.api.call;
import ekoramadhan.linedeer.player.Ui;
import ekoramadhan.shape.Library.Icon.genreIcon;
import ekoramadhan.shape.Library.Icon.searchIcon;
import ekoramadhan.shape.Library.allsong.backcloseBtn;
import ekoramadhan.shape.Library.allsong.iconBack;
import ekoramadhan.shape.Library.allsong.itemBack;
import ekoramadhan.shape.Library.allsong.notFound;
import ekoramadhan.shape.Library.allsong.songIcon;
import ekoramadhan.shape.home.slider.backgroundImg;

import java.util.ArrayList;
import java.util.Collections;
import java.util.Comparator;

import Views.Library.Menu.GenersClass.genersAdapter;
...
import ekoramadhan.shape.Library.allsong.selecttitleBack;

public class Geners extends pagePrototype {
    ...
    public Geners(Context context, int width, int height,int id) {
        ...
        listview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                genersAdapter.Item itemOne = (genersAdapter.Item) view.getChildAt(0);
                genersAdapter.Item itemTwo = (genersAdapter.Item) view.getChildAt(1);
                if(itemOne != null){
        ...
        titleBack.setBackgroundColor(ekoramadhan.shape.home.backgroundImg.Color0);
    ...
    void Selection(){
        if(SelectBack == null){
            SelectBack = selecttitleBack.getFMview(getContext(),false);
