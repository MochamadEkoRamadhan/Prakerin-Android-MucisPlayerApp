...
public class artitstBtns extends FMlyt {
    ...
    public artitstBtns(Context context, int width, int height, String[] data) {
            ...
            Ui.bk.add(new call(){
                ...
                public void onCall(boolean bl) {
                    ...
                    if(fromHtml){
                        ...
                        final  songsPopup mn = new songsPopup(getContext(), Ui.cd.DPW, Ui.cd.DPH,artitstBtns.this.data);
