...
import ekoramadhan.shape.home.backgroundImg;
import ekoramadhan.shape.home.btmStick;
import ekoramadhan.shape.home.equlizerIcon;
import ekoramadhan.shape.home.facebookIcon;
import ekoramadhan.shape.home.folderIcon;
import ekoramadhan.shape.home.mainBtnBack;
import ekoramadhan.shape.home.nextBtn;
import ekoramadhan.shape.home.prevBtn;
import ekoramadhan.shape.home.settingBtn;
...
public class mainHome extends FMlyt{
	...
	public mainHome(final Context context, final int width, final int height) {
		...
		PlayListText.setText("EKO RAMADHAN");
