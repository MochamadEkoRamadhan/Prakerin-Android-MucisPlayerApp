package ekoramadhan.linedeer.player;

import ekoramadhan.linedeer.api.EventCall;

import com.linedeer.music.handler.R;
import ekoramadhan.player.audioHandler;
import ekoramadhan.player.musicHandler;
import ekoramadhan.player.playerEvents;
import ekoramadhan.player.services.servicesBinder;
import ekoramadhan.shape.notification.closeBtn;
import ekoramadhan.shape.notification.nextBtn;
import ekoramadhan.shape.notification.pauseBtn;
import ekoramadhan.shape.notification.playBtn;
import ekoramadhan.shape.notification.prevBtn;
